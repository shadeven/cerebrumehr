...
public class AtcDrugBase extends BaseEntity {
	...
	@Transient
	public String getListSubcategoriesAsString() {
		StringBuilder result = new StringBuilder();

		List<com.oreon.cerebrum.drugs.AtcDrug> tempList = getListSubcategories();
		int count = 0;
		for (com.oreon.cerebrum.drugs.AtcDrug atcDrug : tempList) {
			++count;
			result.append(atcDrug.getDisplayName());
