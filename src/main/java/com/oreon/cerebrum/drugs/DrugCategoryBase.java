...
public class DrugCategoryBase extends BaseEntity {
	...
	@Transient
	public String getListDrugsAsString() {
		StringBuilder result = new StringBuilder();

		List<com.oreon.cerebrum.drugs.Drug> tempList = getListDrugs();
		int count = 0;
		for (com.oreon.cerebrum.drugs.Drug drug : tempList) {
			++count;
			result.append(drug.getDisplayName());
