...
public class FindingBase extends BaseEntity {
	...
	@Transient
	public String getListDifferentialDxsAsString() {
		StringBuilder result = new StringBuilder();

		List<com.oreon.cerebrum.ddx.DifferentialDx> tempList = getListDifferentialDxs();
		int count = 0;
		for (com.oreon.cerebrum.ddx.DifferentialDx differentialDx : tempList) {
			++count;
			result.append(differentialDx.getDisplayName());
