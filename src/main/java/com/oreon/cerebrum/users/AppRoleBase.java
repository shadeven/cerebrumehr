...
public class AppRoleBase extends BaseEntity {
	...
	@Transient
	public String getListAppUsersAsString() {
		StringBuilder result = new StringBuilder();

		List<com.oreon.cerebrum.users.AppUser> tempList = getListAppUsers();
		int count = 0;
		for (com.oreon.cerebrum.users.AppUser appUser : tempList) {
			++count;
			result.append(appUser.getDisplayName());
