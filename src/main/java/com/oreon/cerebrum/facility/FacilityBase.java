...
public class FacilityBase extends BaseEntity {
	...
	@Transient
	public String getListWardsAsString() {
		StringBuilder result = new StringBuilder();

		List<com.oreon.cerebrum.facility.Ward> tempList = getListWards();
		int count = 0;
		for (com.oreon.cerebrum.facility.Ward ward : tempList) {
			++count;
			result.append(ward.getDisplayName());
